...
<section class="checkout">
    ...
    <form action="" method="post">
        <div class="cart-items">
            ...
            <p><span class="name"><?php echo $product['product_name'] ?></span><span
                    class="price">$<?php echo $product['product_price'] . " x " . $product['product_qty'] ?></span></p>
            <?php } ?>
            <p class="grand-total"><span class="name">grand total :</span> <span
                    class="price">$<?php echo $total_price ?></span></p>
        ...
        <input type="submit" value="place order" name="add_order"
            class="btn order-btn <?php echo count($all_product_cart) == 0  ? 'checkout_btn' : ''; ?>">
    </form>
</section>
<?php
