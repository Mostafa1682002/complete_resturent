    ...
    <section class="products">
                    ...
                    <div class="box">
                        <form method="post">
                            ...
                            <div class="flex">
                                ...
                                <input type="number" name="qty" class="qty" min="1" max="99" value="<?php echo  $product['product_qty']  ?>" onkeypress="if(this.value.length == 2) return false;">
        ...
        <div class="more-btn">
            <form action="" method="post">
                <button type="submit" name="deleteAll" onclick="return confirm('delete all from cart?');" class="delete-btn <?php echo count($all_product_cart) == 0  ? 'checkout_btn' : ''; ?>">delete
                    all</button>
            </form>
        </div>
    </section>
